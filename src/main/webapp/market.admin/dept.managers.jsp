...
<div>
    <div class="flex justify-between items-center my-5">
        <h1 class="text-xl font-semibold text-blue-800 text-2xl">Dept Managers</h1>
        <a href="<%=url+"market-admin/add-dept-manager"%>" class="h-12 w-34 rounded-lg bg-blue-200 font-semibold text-gray-600 flex items-center justify-center px-2">
    ...
    <table class="w-full rounded-md overflow-hidden">
        ...
        <tr class="bg-blue-50">
            ...
            <th class="p-4 font-semibold text-start">Department</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="manager" items="${managers}">
            <tr class="h-10 even:bg-gray-50">
                ...
                <td class="p-3">${manager.getCategory().getCategoryName()}</td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
