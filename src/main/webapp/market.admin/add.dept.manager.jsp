...
<h1 class="text-xl font-semibold text-blue-800 text-2xl">Add Dept Manager</h1>
<div class="bg-gray-50 mx-auto p-6 rounded-md mt-4 border border-blue-100">
    <form action="<%=url+"market-admin/add-dept-manager"%>" method="post">
        <div class="flex item-center gap-3">
            ...
            <div class="border p-2 h-12 relative flex-1 overflow-hidden rounded-md">
                <label class="text-lg px-2" for="category">Category</label>
                <select id="category" name="category-id" class="h-full focus:left-0 focus:outline-blue-500 absolute w-full top-0 p-2 rounded-md">
